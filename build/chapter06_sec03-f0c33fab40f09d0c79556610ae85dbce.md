...
```{figure} pics/fig06_damped_oscillation.svg
---
width: 75%
name: fig06_damped_oscillation
---
Graph of the damped oscillation $x(t) = 0.10\,e^{-0.5\,t}\cos(3t)$ with the
exponential envelope $\pm 0.10\,e^{-0.5\,t}$ shown as dashed curves.
