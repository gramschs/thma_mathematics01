...
Curve sketching organizes everything we know about a function that is already given to us. In engineering the more common situation is different: we have a design goal and a set of constraints, and we must find the parameter values that achieve the best outcome. Setting up and solving such optimization problems is one of the most direct applications of differential calculus to real engineering decisions.
